...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    User2 *user =[User2 sharedUser];
    user.promotion=[NSString stringWithFormat:@"a free %@",[items objectAtIndex:[[numbers_a objectAtIndex:indexPath.section] intValue]-[[numbers objectAtIndex:indexPath.section] intValue]+indexPath.row+indexPath.section]];
    [self dismissModalViewControllerAnimated:YES];
